  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 min-h-screen pt-16">
      ...
      <div className="flex flex-col justify-center px-8 md:px-16 lg:px-20 py-20 bg-site-bg border-r border-site-border">
        {/* Label */}
        <p className="section-label-line text-[11px] font-semibold tracking-widest2 uppercase text-sage mb-6">
        ...
        <h1 className="font-serif text-[clamp(52px,6vw,80px)] font-semibold leading-[1.05] tracking-tight text-site-text mb-7">
          Pravo,<br />
          ki{" "}
          <em className="italic text-sage-dark not-italic" style={{ fontStyle: "italic" }}>
            odgovori
          </em>
          <br />
          takoj.
        ...
        <div className="flex flex-wrap gap-4">
          <a
            href="#cenik"
            className="bg-sage-dark text-white px-8 py-3.5 rounded-sm text-[13px] font-semibold tracking-[0.06em] uppercase hover:bg-sage transition-colors duration-200"
          >
            Začni zdaj
          </a>
          <a
            href="#demo"
            className="border border-site-border text-site-mid px-7 py-3.5 rounded-sm text-[13px] font-medium tracking-[0.04em] uppercase hover:border-sage hover:text-sage-dark transition-colors duration-200"
          >
            Oglej si demo
          </a>
        </div>
      ...
      <div className="relative flex flex-col justify-center px-10 md:px-16 py-20 bg-sage-dark overflow-hidden">
        ...
        {/* Big stat */}
        <div className="mb-12">
          <p className="font-serif text-[80px] font-semibold leading-none text-white mb-2">6</p>
        ...
        <ul className="flex flex-col gap-6">
          {features.map((f) => (
            <li key={f.title} className="flex gap-4 items-start">
              <span className="w-9 h-9 rounded-full bg-white/10 border border-white/15 flex items-center justify-center text-base flex-shrink-0">
                {f.icon}
              </span>
              <div>
