...
/** File with text — flowing document */
  ...
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none">
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M12 14h8M12 18h6M12 22h4" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" opacity="0.45" />
    </svg>
  );
}

/** Calendar — with elegant serif-style date */
export function IconCalendar({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none">
      ...
      <path d="M11 3v5M21 3v5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
      <rect x="4" y="6" width="24" height="6" rx="3" fill="currentColor" opacity="0.06" />
      {/* Date number — serif-style */}
      <text x="16" y="23" textAnchor="middle" fontFamily="serif" fontSize="9" fill="currentColor" opacity="0.35">§</text>
    </svg>
  );
}

/** Shield with check — flowing protective shape */
export function IconShieldCheck({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none">
      <path
        d="M16 2.5C13 5 9.5 6.5 5 7c0 8 2.5 16 11 22.5C24.5 23 27 15 27 7c-4.5-.5-8-2-11-4.5Z"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinejoin="round"
      />
...
/** Exchange arrows — flowing bidirectional curves */
export function IconArrowsExchange({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none">
      <path
        d="M4 10h20c1 0 2 .5 2 1.5"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinecap="round"
      />
      ...
      />
      <path
        d="M28 22H8c-1 0-2-.5-2-1.5"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinecap="round"
      />
      <path
        d="M12 18l-4.5 4 4.5 4"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinecap="round"
        strokeLinejoin="round"
